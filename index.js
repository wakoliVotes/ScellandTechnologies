  ...
  function (t, e, n) {
    ...
    function mt(t) {
      var e,
        ...
        O = (b[T] || {}).refState,
        x = y.getRefType(c),
        A = I.reducedMotion && g.ReducedMotionTypes[s.actionTypeId];
      if (A && d)
        switch (
    ...
    function yt(t, e) {
      ...
      var n = t.elementId,
        ...
        o = i.ref;
      i.refType === x && B(o, r, y), e.dispatch((0, m.instanceRemoved)(t.id));
    }
    function _t(t, e, n) {
      ...
      (t.exports = function (t, e) {
        ...
        function I() {
          !(function () {
            ...
            e.each(O),
              e.each(w),
              g.length && (r.scroll.on(x), setTimeout(x, 1));
            E.length && r.load(A);
        ...
        function x() {
          for (
            var t = u.scrollTop(), e = u.height(), n = g.length, r = 0;
            r < n;
            r++
          ) {
            var i = g[r],
        ...
        function R(e, r, i, o) {
          ...
          function m() {
            ...
            "auto" === g.width && h.set({ width: "auto" }),
              "auto" === g.height && h.set({ height: "auto" }),
              a && a();
          }
        }
        function C(t, e, n) {
        ...
        switch (i) {
          ...
          case ut:
            var I = n.config,
              ...
              O = I.bValue,
              x = I.aValue;
            return { rValue: w, gValue: T, bValue: O, aValue: x };
          case rt:
          ...
          handler: function (t) {
            ...
            return (
              ...
              (u !== h.EventBasedOn.ELEMENT || A || A !== a.elementHovered) &&
                ((O = f ? 1 - O : O),
                e.dispatch((0, E.parameterChanged)(x, O))),
              { elementHovered: A, clientX: v, clientY: m, pageX: _, pageY: I }
            );
          },
        }),
        (0, o.default)(r, B, {
        ...
        (0, o.default)(r, X, {
          ...
          handler: function (t) {
            ...
            if (d === h.EventBasedOn.VIEWPORT) {
              ...
              return (
                x !== o.scrollPercent &&
                  n.dispatch((0, E.parameterChanged)(v, x)),
                { scrollPercent: x }
              );
            }
            var A = K(i, v),
            ...
            return (
              P !== o.scrollPercent &&
                n.dispatch((0, E.parameterChanged)(A, P)),
              { scrollPercent: P }
            );
          },
        }),
      ...
      (t.exports = function (t, e) {
        ...
        function S(e, i) {
          ...
          f ||
            ...
            (f.mouseUpOutside = (function (e) {
              e.mouseUpOutside && x.off(w, e.mouseUpOutside);
              return s(function (n) {
                if (e.open) {
                  var i = t(n.target);
        ...
        function N(e) {
          if (!e.open) {
            ...
            var i = r.env("editor");
            n || x.on(w, e.mouseUpOutside),
              e.hovering && !i && e.el.on(I, e.mouseLeave),
              e.hovering && i && x.on(b, e.mouseMoveOutside),
        ...
        function L(t) {
          ...
          if (t.open && (!t.config.hover || !t.hovering || r)) {
            ...
            if (
              (g.outro(0, t.el[0]),
              x.off(w, t.mouseUpOutside),
              x.off(b, t.mouseMoveOutside),
      ...
      (t.exports = function (t, e) {
        ...
        function _(e, n) {
          ...
          (i.handler = null),
            ...
            m.test(s) ? (i.handler = x) : s || (o ? (i.handler = O) : y());
        }
        function b(t) {
    ...
    function f(t, e, n, r) {
      ...
      (m.build = function () {
        return (
          ...
          f.container.on("click", D("view"), I).on("dragstart", D("img"), x),
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "2821e135-7aa8-6b95-31e7-9619bcd3136d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-3": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "2821e135-7aa8-6b95-31e7-9619bcd3136a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".top-line",
                  selectorGuids: ["6b515e59-0599-8e3a-8192-ab78faf77d8b"],
                },
                yValue: 10,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["9239a921-f55e-7351-f266-252e5defee18"],
                },
                yValue: -10,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["e791854a-3421-9c4b-c185-5d0e8473d601"],
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".top-banner",
                  selectorGuids: ["1966e2cb-c024-7167-2951-913d3d4d05cf"],
                },
                value: "none",
              },
            },
